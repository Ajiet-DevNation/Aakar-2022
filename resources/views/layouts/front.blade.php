...
<title>Aakar | Not just an event, an experience</title>
<meta name="title" content="Aakar | Not just an event, an experience">
...
<link rel="stylesheet" href="{{asset('frontend/css/style.css?v4')}}">
...
<div class="preloader">
  <div class="inner" >
    <figure><img class="img-fluid" src="{{asset('frontend/images/logo.webp')}}" alt="Image"></figure>
        ...
        <div class="site-menu">
          <ul>
            ...
            <li>
              ...
              @else
              <a href="{{route('login')}}"  class="btn btn-primary"> <span class="text-white">Login</span>  </a>
              @endif
            </li>
          </ul>
        </div>
