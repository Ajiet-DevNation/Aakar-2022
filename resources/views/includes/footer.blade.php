<footer class="footer">
  <div class="container">
    <div class="row pt-4">
      <div class="logo col-lg-3 pt-6"> 
        <img src="{{asset('frontend/images/AakarTitlePBsponsor.webp')}}" alt="Image"> 
      </div>
      ...
      <div class="col-lg-3">
        <div style="margin: 2rem" class="footer-widget">
          ...
          <p>Phone: <a href="tel:+91 824 2862 200">+91 824 2862 200</a></p>
        </div>
      </div>
    </div>
  </div>
  <div class="bottom-bar">
    <div class="container"> 
      ...
      <li><a href="https://www.instagram.com/_ajiet_aakar_official_/?hl=en"><i class="fab fa-instagram"></i> <span>Instagram</span></a></li>
